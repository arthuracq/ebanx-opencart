  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-ebanx_express_mx2" class="btn btn-primary"><i class="fa fa-save"></i> <?php echo $button_save; ?></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-ebanx_express_mx2" class="form-horizontal">
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-ebanx_express_mx-merchant-key"><?php echo $entry_merchant_key; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-ebanx_express_mx-installments"><?php echo $entry_enable_installments; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-ebanx_express_mx-max-installments"><?php echo $entry_max_installments; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-ebanx_express_mx-installments-interest"><?php echo $entry_installments_interest; ?></label>
            <div class="col-sm-10">
